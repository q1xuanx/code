...
namespace Nhom8_Bai3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string[] s1 = { "SV001", "Trần Văn Nam", DateTime.ParseExact("20/08/1985 12:00:00","dd/MM/yyyy hh:mm:ss",null).ToString(), "Công nghệ thông tin" };
            string[] s2 = { "SV002", "Nguyễn Thị Tuyết", DateTime.ParseExact("25/08/1986 12:00:00", "dd/MM/yyyy hh:mm:ss", null).ToString(), "Kế toán khoa 1" };
            string[] s3 = { "SV003", "Nguyễn Thị Kim Tuyến", DateTime.ParseExact("21/03/1984 12:00:00", "dd/MM/yyyy hh:mm:ss", null).ToString(), "Kế toán khoa 1" };
